...
module.exports.config = {
  ...
  version: "1.0.1",
  hasPermssion: 0,
  credits: "𝐀𝐘𝐀𝐍 ☢️_𖣘 -𝐁𝐎𝐓 ⚠️ 𝑻𝑬𝑨𝑴_ ☢️",
  description: "goibot",
...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Ayan") || (event.body.toLowerCase() == "Ayan bai") || (event.body.toLowerCase() == "@Ayan ッ") || (event.body.toLowerCase() == "উল্লাস")) {
